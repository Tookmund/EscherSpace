...
/*****************************************************/
//Added g_speed variable info-JG 3/6/08
/*
=================
ServerOptions_SpeedStatusBar
=================
*/
static void ServerOptions_SpeedStatusBar( void* ptr ) {
	switch( ((menucommon_s*)ptr)->id ) {
	default:
		UI_DrawString( 320, 440, "1=Fastest 3=Slowest", UI_CENTER|UI_SMALLFONT, colorWhite );
		break;
	}
}
...
/**********************************************************************************************/
	//Added g_speed variable-JG 3/6/08
	y += BIGCHAR_HEIGHT+2;
	s_serveroptions.playerspeed.generic.type       = MTYPE_FIELD;
	s_serveroptions.playerspeed.generic.name       = "Player Speed:";
	s_serveroptions.playerspeed.generic.flags      = QMF_NUMBERSONLY|QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_serveroptions.playerspeed.generic.x	         = OPTIONS_X;
	s_serveroptions.playerspeed.generic.y	         = y;
	s_serveroptions.playerspeed.generic.statusbar  = ServerOptions_SpeedStatusBar;
	s_serveroptions.playerspeed.field.widthInChars = 3;
	s_serveroptions.playerspeed.field.maxchars     = 3;
/**********************************************************************************************/
/******************************************************************************************************/
	  //03-13-08-JG
	  y += BIGCHAR_HEIGHT+2;
      s_serveroptions.maxclients.generic.type       = MTYPE_FIELD;
      s_serveroptions.maxclients.generic.name       = "MaxClients:";
      s_serveroptions.maxclients.generic.flags      = QMF_NUMBERSONLY|QMF_PULSEIFFOCUS|QMF_SMALLFONT;
      s_serveroptions.maxclients.generic.x	         = OPTIONS_X;
      s_serveroptions.maxclients.generic.y	         = y;
      //s_serveroptions.maxclients.generic.statusbar  = ServerOptions_StatusBar;
